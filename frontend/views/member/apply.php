...
<div class="bs_deliver" style="margin-top: -66px;">
    ...
    <div class="dl_content dl_gray_bg">
        ...
        <div class="dl_bigwrap dl_gray_bg clearfix">
            <div class="leftmenu" style="width:160px;">
                <div class="dl_greyline_bg">
                    <span class="dl_menutit">个人中心</span>
                </div>
                <ul class="dl_menulist clearfix">
                    <li class="selected applychoose" style="height: 35px;"> <a href="?r=member/apply" class="profile"> <span class="dl_menuchose">我的申请</span></a> </li>
                    <li> <a href="?r=member/resume" class="profile">我的简历</a> </li>
