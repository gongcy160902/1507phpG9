                    ...
                    <div class="login-hearder">
                     <?   if (!Yii::$app->user->isGuest) {?>
                         ...
                         <ul class="header-login" >
                             <li class="welcome" style="margin-top: -1px;"><span><span class="userName" ></span>
                                     <?= $name= Yii::$app->user->identity->username ?>，欢迎您！
                                 </span></li>
                             <li class="PortalIndex"><a href="?r=member/resume"><span>个人中心</span></a></li>
                             <li class="LogoutUrl">
        ...
        <div class="bs-module">
            <div class="menu-simple ">
                <ul id="portalmenu">
                    ...
                    <li><a target="_self" href="?r=employment/index" class="">全部职位</a> </li>
                    <li><a target="_self" href="?r=social/index" class="">社会招聘</a> </li>
                    <li><a target="_self" href="?r=contace/about" class="">公司介绍</a> </li>
                    <li><a target="_self" href="?r=contace/index" class="">联系我们</a> </li>
                </ul>
            </div>
        </div>
        <!--module:menu end-->
