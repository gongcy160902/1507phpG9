    ...
    <div class="dl_content dl_gray_bg">
        ...
        <div class="dl_liucheng dl_top_table">
            ...
            <table align="center" class="dl_top_ico">
                ...
                <tr>
                    <td align="center">
                        <ul class="dl_picliu">
                            <li class="basic" onclick="BSGlobal.navigate(0);" style="margin-left:300px"><a href="javascript:void(0);" onclick="BSGlobal.navigate(0);"><span class="dl_grey3">1基本信息</span></a></li>
        ...
        <div>
            ...
            <div class="dl_bacwrap dl_new_error_wrap">
                <div class="mainwrap" style="margin-top: 30px;">
                    <br />
                    ...
                    <? echo $form->field($model, 'birth_time')->dropDownList([$nian], ['prompt'=>'年','style'=>'width:120px'])?>
                    <?= $form->field($model, 'work_year')->textInput() ?>
                    <?= $form->field($model, 'hk_address')->textInput() ?>
                    <?= $form->field($model, 'address')->textInput() ?>
                    <?= $form->field($model, 'email')->textInput() ?>

                    <div class="form-group">
                        <div class="col-lg-offset-1 col-lg-11">
                            <?= Html::submitButton('保存并下一步', ['class' => 'btn btn-primary']) ?>
                        </div>
                    </div>
                    <?php ActiveForm::end() ?>
