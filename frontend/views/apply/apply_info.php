        ...
        <div>
            ...
            <div class="dl_bacwrap dl_new_error_wrap">
                <div class="mainwrap">
                    ...
                    <form method="post" id="0738c88a-d372-4401-a39d-782141723d86" name="0738c88a-d372-4401-a39d-782141723d86" class="formPart" enctype="multipart/form-data" action="?r=apply/spply_info">
                    <div class="clearfix">
                                        ...
                                        <div class="form_part_container columnone">
                                            <ul>
                                                <li>
                                                    ...
                                                    <input class="{required:true,messages:&quot;请填写姓名&quot;} mul_input"
                                                           name="username" id="4c037148-140a-4c2b-b87a-b97609215d7011" value="" />
                                                    <span class="desc"></span>
                                                </li>
                                                <li>
                                                    <label class="current label_required">性别：</label>
                                                ...
                                                <li>
                                                    <label class="current label_required">出生日期：</label>
                                                    <input class="mul_input Wdate" name="birthday"
                                                           id="436ab7a4-67a1-4819-a238-d5d34eb0717611" value="" />
                                                    <span class="desc"></span>
                                                </li>

                                                <li>
                                                    <label class="current label_required">邮箱：</label>
                                                    <input class="{required:true,messages:&quot;请填写邮箱&quot;}
                                                    mul_input" name="email" id="67a5c587-4f90-4ae7-819f-eb3dba9ea39911" value="" />
                                                    <span class="desc"></span>
                                                </li>

                                                 <li>
                                                     <label class="current label_required">手机号：</label>
                                                     <input class="{required:true,messages:'请填写手机号'} mul_input "
                                                            name="phone" id="acb9b67f-9643-41fb-a7fe-5ff8d742ccdf11" value="" />
                                                 </li>
                                            </ul>
                                        </div>
                                        <div class="clear"></div>
                                        ...
                                        <div class="form_part_container columnone">
                                            <ul>
                                                <li>
                                                    ...
                                                    <select name="year" id="RecruitmentPortalPersonProfile_YearsOfWork"
                                                            class="mul_select">
                                                ...
                                                <li>
                                                    ...
                                                    <input type="hidden" name="RecruitmentPortalPersonProfile_IDPhoto"
                                                           id="c71310e0-0bef-4173-9826-21a572d4943d11" value="" />
                                                    <span><a class="uploadfile" id="c71310e0-0bef-4173-9826-21a572d4943d11_btn">上传</a></span>
                                                    <span class="desc uploaddesc">推荐1寸照片尺寸，70x100象素。支持jpg，jpeg, gif，bmp或png格式，大小不超过512k</span>
                                                    <ul id="c71310e0-0bef-4173-9826-21a572d4943d11_info" class="uploadfilescontainer" style="margin-left:70px;"></ul>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="clear"></div>
                                ...
                                <div class="form_container" id="RecruitmentPortal.Objective">
                                    ...
                                    <div class="form_part">
                                        <div class="form_part_container columnone">
                                            <ul>
                                                <li>
                                                    <label class="current label_required">期望从事行业：</label>
                                                    <input class="mul_input industry" name="work_name"
                                                           id="e5688d4a-bad3-48fb-842e-0ae7df7036d51212_txt" value="" />
                                                           <input type="hidden" id="e5688d4a-bad3-48fb-842e-0ae7df7036d51212"
                                                           name="RecruitmentPortalObjective_ExpectIndustry"
                                                           class="{required:true,messages:&quot;请填写期望从事行业&quot;}" />
                                                </li>

                                                <li> <label class="current">期望从事职业：</label>
                                                    <input type="text" readonly="true" displayname="期望从事职业"
                                                           constname="JobCategory" value="" class="Ajson ConstDictSingleSelect"
                                                           id="RecruitmentPortalObjective_ExpectJobCategory_Id" />
                                                    <input class="ResidenceState" type="hidden" value=""
                                                           name="work_type" id="RecruitmentPortalObjective_ExpectJobCategory" />
                                                </li>

                                                <li>
                                                    <label class="current label_required">期望工作城市：</label>
                                                    <input name="" id="bdb0be18-1b30-4001-817e-34807ab4d94b1212_txt" value="" />
                                                    <input type="hidden" value="" id="bdb0be18-1b30-4001-817e-34807ab4d94b1212"
                                                           name="work_city" class="{required:true,messages:&quot;请填写期望工作城市&quot;}" />
                                                </li>

                                                <li>
                                                    <label>期望月薪(税前)：</label>
                                                    <select name="money" id="RecruitmentPortalObjective_ExpectSalary" class="mul_select">
                                                        <option value="">请选择</option>
                    ...
                    <div class="dl_subbtn dl_htline32">
                        <span class="dl_btn_lev dl_ft14_grey dl_padr10"><a name="btnCancel" href="?r=apply/apply_info"><b>取消</b></a></span>
